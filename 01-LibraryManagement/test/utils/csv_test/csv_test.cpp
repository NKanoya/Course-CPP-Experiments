...
namespace Test {
    ...
    void CSVWriterTest() {
        ...
        parser.addEntry(std::cout, Utils::makeArrayView(list1));

        // output a list with inadequate columns
        std::vector<std::string> list2 = {"123",
                                          "Lack Columns"};
        parser.addEntry(std::cout, Utils::makeArrayView(list2));
        ...
        std::vector<std::string> list3 = {"123",
                                          ...
                                          "Sample Summary with \"Quotation Marks\" and comma \",\"!",
                                          "Additional Columns"};
        parser.addEntry(std::cout, Utils::makeArrayView(list3));
    }
    ...
    void csvReaderTest() {
        ...
        readingState = reader.readLine(ss1, Utils::makeArrayView(arr));         // read the line from the stream
        ...
        readingState = reader.readLine(ss2, Utils::makeArrayView(arr));
